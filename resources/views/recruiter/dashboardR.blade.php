...
<div class="row">
  <div class="row mb-2">
    <br>
    <div class="col-sm-6">
      <h1 class="m-0">Hello, RECRUITER!</h1>
    </div>
    <br>
    <br>
    <div class="col-sm-6">
      ...
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboardA') }}">Recruiter</a></li>
...
<div class="row">
  ...
  <div class="col-lg-6">
    <div class="card">
      <div class="card-header text-white d-flex justify-content-between align-items-center" style="background-color:rgb(0, 56, 35);">
        <h3 class="card-title">
  ...
  @include('recruiter.partials.informations')
</div>

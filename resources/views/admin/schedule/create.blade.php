        ...
        <div class="card-body">
            <form action="{{ route('admin.schedule.store') }}" method="POST">
                ...
                <div id="repeatDays" class="form-group mb-3">
                    ...
                    <div class="form-text">For weekly events, select which days of the week this event occurs</div>
                </div>
    ...
    $(document).ready(function () {
        ...
        $('input[name="repeat"]').change(function () {
            ...
            if (repeatValue === 'none' || repeatValue === 'yearly') {
                ...
                $('#repeatDays input[type="checkbox"]').prop('required', false);
            } else if (repeatValue === 'weekly') {
                $('#repeatDays').show();
                $('#specificDate').hide();
                $('#schedule_date').prop('required', false);
                $('#repeatDays input[type="checkbox"]').prop('required', true);
            } else {
        ...
        $('form').submit(function(e) {
            ...
            } else if (repeatValue === 'weekly' && !$('input[name="repeat_days[]"]:checked').length) {
                e.preventDefault();

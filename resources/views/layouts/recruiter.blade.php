...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: rgb(0, 56, 35);">
    <!-- Brand Logo -->
    <a href="{{ route('recruiter.dashboardR') }}" class="brand-link">
    ...
    <!-- Sidebar -->
    <div class="sidebar" style="background-color:rgb(0, 56, 35);">
        <!-- Sidebar user panel -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">RECRUITER FUNCTIONS</li>

          <!-- List dalam sistem -->

          <li class="nav-item">
            <a href="{{route('recruiter.dashboardR')}}" class="nav-link"> 
          ...
          <li class="nav-item">
            <a href="{{route('recruiter.discover')}}" class="nav-link"> 
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('recruiter.jobapplication.index')}}" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('recruiter.schedule')}}" class="nav-link">
    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <div class="content-wrapper" style="background-color:rgb(239, 255, 239)">

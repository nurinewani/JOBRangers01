...
<div class="container-fluid">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <form action="{{ route('user.jobs.index') }}" method="GET" class="form-inline">
                ...
                @if(request('status'))
                    <a href="{{ route('user.jobs.index') }}" class="btn btn-secondary">Clear Filter</a>
                @endif
            </form>
        </div>
                    ...
                    <tbody>
                        @forelse ($jobs as $job)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('user.jobs.show', $job->id) }}" class="btn btn-info rounded mr-2">
                                            <i class="fas fa-eye mr-1"></i> View
                                        </a>
                                        <form action="{{ route('user.jobs.destroy', $job->id) }}" method="POST" 
